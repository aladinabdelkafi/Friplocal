<div class="site-blocks-cover overlay" style="background-image: url(ac/images/vente-de-vêtement-en-ligne-01.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
  <div class="container">
      ...
      <div class="col-md-12">
        ...
        <div class="row justify-content-center mb-4">
          <div class="col-md-8 text-center">
            <h1 class="" data-aos="fade-up">les meilleure annonce en France</h1>
              ...
              <div class="col-lg-12 mb-4 mb-xl-0 col-xl-3">
                <div class="select-wrap">
                  ...
                  <select class="form-control rounded" name="rech_marque" id="">
                    ...
                    <?php
                    $mar = new marque("", "");
                    $lis_marque = $mar->liste($cnx);
                    foreach ($lis_marque as $mar) {
  ...
  <div class="container">
    ...
    <div class="overlap-category mb-5">
      <div class="row align-items-stretch no-gutters">
        ...
        foreach ($lis_marque as $mar) {
          $anno = new annonce("", "", "", "", "", "", "", "", "", "", "", "", "");
          $nb = $anno->count_par_marque($cnx, $mar->id);
        ...
        ?>
          ...
          <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
            <a href="#" class="popular-category h-100">
              ...
              <span class="caption mb-2 d-block"><?php echo ($mar->nom_marq); ?></span>
